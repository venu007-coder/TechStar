...
// Additional headers
$headers .= 'To: info@altechstar.com' . "\r\n";
$headers .= 'From: '.$_POST['email'].  "\r\n";

mail ('info@altechstar.com',$subject,$msg,$headers);
  ...
  <div class="container">
    ...
    <div id="header-rgt">
    	<div class="clear1">
        	...
        	<p>
            	<a href="#" class="btn-slide">Newsletter Signup</a>
                &nbsp; &nbsp;|&nbsp; &nbsp;
                Follow Us:&nbsp;
            </p>
			<div id="newslettersignup">
				...
				<p>Sign up now and receive the latest news and events.</p>
				<div>
					<input type="text" class="textbox1" onclick="this.value='';" onfocus="this.select()" onblur="this.value=!this.value?'Enter your emaill address':this.value;" value="Enter your emaill address" />
					<input type="button" class="signupnow-button" />
				</div>
			</div>
            <span>
            	<a href="#"><img src="images/facebook-icon.gif" alt="" /></a>
                <a href="#"><img src="images/tweetter-icon.gif" alt="" /></a>
            </span>
        </div>
		</div>
		<ul id="menu">
...
<div id="wrapper">
  <div class="container">
  	<div id="content">
		...
		<div id="sidebar">
			<div class="latestnews" style="padding-top:0;">
				<h2>News &amp; Events</h2>
				<div class="news1">
					<p><span>October 07, 2011</span><br /><a href="news-events.html">Lorem ipsum dolor sit<br />amet, consectetur adipiscing elit....</a></p>
				</div>
				<div class="news1">
					<p><span>October 07, 2011</span><br /><a href="news-events.html">Lorem ipsum dolor sit<br />amet, consectetur adipiscing elit....</a></p>
				</div>
		...
		<div id="rgt-content">
			<div class="contact-details">
				...
				<div class="contact-address">
					<p><strong class="green-title">USA :</strong>Altech Star Inc.<br />4365 US 1 South, Suite 205<br />Princeton, NJ 08540<br />
                    <strong>Phone:</strong> 609-520-9000<br /><strong>email:</strong><a href="mailto:sales@altechstar.com">sales@altechstar.com</a></p>
                    
                    <p><strong class="green-title">India :</strong>Altech Star BPO Pvt. Ltd.<br />DP-111 (S.P) F-18A, Ambattur Industrial Estate,<br />Chennai - 600 058<br />
                    <strong>Phone:</strong> 91-44- 2635 0145 / 2635 0146<br /><strong>email:</strong><a href="mailto:sales@altechindia.com">sales@altechindia.com</a></p>
                    
                    <p><strong class="green-title">UAE :</strong>Star Software Solutions Pvt. Ltd., <br />P.O.Box No 5239, <br />Dubai.<br />
                    <strong>Phone:</strong> + 9714 7073165<br /><strong>email:</strong><a href="mailto:sales@altechindia.com">sales@altechindia.com</a></p>
