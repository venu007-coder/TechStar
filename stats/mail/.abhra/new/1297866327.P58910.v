...
Received: from mx108.stngva01.us.mxservers.net (198.173.112.45)
	by mail19f.g19.rapidsite.net (RS ver 1.0.95vs) with SMTP id 1-0871646326
	for <abhra@altechstar.com>; Wed, 16 Feb 2011 09:25:26 -0500 (EST)
Received: from unknown [76.74.252.24] (EHLO rs78.luxhv.com)
	by va1-mx108.stngva01.us.mxservers.net (mxl_mta-3.1.0-05)
	with ESMTP id 65edb5d4.1646062496.671435.00-019.va1-mx108.stngva01.us.mxservers.net (envelope-from <andy@vlinkinfo.com>);
	Wed, 16 Feb 2011 09:25:26 -0500 (EST)
Received: from ip-10-196-81-219.ec2.internal (ec2-184-72-246-77.compute-1.amazonaws.com [184.72.246.77])
	(authenticated bits=0)
	by rs78.luxhv.com (8.13.8/8.13.8) with ESMTP id p1GEPKZY027649;
	Wed, 16 Feb 2011 08:25:20 -0600
Date: Wed, 16 Feb 2011 09:25:20 -0500 (GMT-05:00)
From: Andy Duggal <andy@vlinkinfo.com>
To: andy@vlinkinfo.com
Message-ID: <1297866320016.30086663648466627.andy@vlinkinfo.com>
Subject: SSAS Developer contract position
MIME-Version: 1.0
Content-Type: multipart/mixed; 
	boundary="=_reb-r1070815A-t4D5BDE56"
Importance: Normal
X-Lux-Comment: Message p1GEPKZY027649 sent by user #76870; report Spam, UCE, or Abuse to abuse@luxsci.us
...
<table align="center" width="100%" cellpadding="10" cellspacing="0" border="1" style="border-bottom-color: #006aaf; border-top-color: #006aaf; border-collapse: collapse; border-right-color: #006aaf; border-left-color: #006aaf">
    <tbody>
        <tr>
            <td width="100%">
            <div id="customerLogo"><img src="cid:LpemlgkVri" alt="" border="0"><br>
            <br>
            12 months plus contract in Hartford, CT. Need a minimum of 9 years experienced guy. SSAS is the main key. Rate: Negotiable<br>
            <br>
            <div style="margin: 0in 0in 0pt"><span style="color: blue; font-size: 10pt">Things particularly important &ndash; his experience with MDX queries, aggregate functions, and things like slowly changing dimensions and roll ups.&nbsp; This is a SSAS developer position. This is the key experience needed.</span></div>
            <br>
            <br>
            <div style="margin: 0in 0in 0pt"><span style="font-family: 'Arial','sans-serif'; color: blue; font-size: 10pt">Recent SSAS development experience required<br>
            SSAS in a DB2 environment&nbsp; preffered<br>
            *&nbsp;</span><span style="font-family: 'Arial','sans-serif'; color: blue; font-size: 10pt">Extensive knowledge of the system development life cycle, the client area's functions and systems, and application program development alternatives.<br>
            * Technical leadership skills.<br>
            * Excellent communication skills. <br>
            *Health care Industry experience preferred.</span></div>
            <div style="margin: 0in 0in 0pt"><span style="font-family: 'Arial','sans-serif'; color: blue; font-size: 10pt">* Analytical ability.<br>
            * Ability to work effectively with clients and IT management and staff.<br>
            <br>
            </span></div>
            </div>
