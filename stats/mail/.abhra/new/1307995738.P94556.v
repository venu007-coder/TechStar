...
Received: from mx11.stngva01.us.mxservers.net (204.202.242.100)
	by mail19j.g19.rapidsite.net (RS ver 1.0.95vs) with SMTP id 2-0388835737
	for <abhra@altechstar.com>; Mon, 13 Jun 2011 16:08:57 -0400 (EDT)
Received: from unknown [76.74.252.24] (EHLO rs78.luxhv.com)
	by va1-mx11.stngva01.us.mxservers.net (mxl_mta-3.1.0-05)
	with ESMTP id 95e66fd4.2664336288.65382.00-002.va1-mx11.stngva01.us.mxservers.net (envelope-from <arun@vlinkinfo.com>);
	Mon, 13 Jun 2011 16:08:57 -0400 (EDT)
Received: from ip-10-218-41-168.ec2.internal (ec2-184-72-246-77.compute-1.amazonaws.com [184.72.246.77])
	(authenticated bits=0)
	by rs78.luxhv.com (8.13.8/8.13.8) with ESMTP id p5DErIfL019475;
	Mon, 13 Jun 2011 09:53:18 -0500
Date: Mon, 13 Jun 2011 10:53:17 -0400 (EDT)
From: Arun Chouhan <arun@vlinkinfo.com>
To: arun@vlinkinfo.com
Message-ID: <1307976797772.45825315439471836.arun@vlinkinfo.com>
Subject: Back Fill Position Urgent Required Sharepoint Developer [VLINK_953]
MIME-Version: 1.0
Content-Type: multipart/mixed; 
	boundary="=_reb-r7A264CA1-t4DF66E59"
Importance: Normal
X-Lux-Comment: Message p5DErIfL019475 sent by user #76870; report Spam, UCE, or Abuse to abuse@luxsci.us
...
<table align="center" width="100%" cellpadding="10" cellspacing="0" border="1" style="border-bottom-color: #51ae70; border-top-color: #51ae70; border-collapse: collapse; border-right-color: #51ae70; border-left-color: #51ae70">
    <tbody>
        <tr>
            <td>
            <div id="customerLogo"><img src="cid:qMTpAro3kB" alt="" border="0"></div>
            <div id="messagebody"><br>
            <br>
            Hello Partner,<br>
            <br>
            Please send qualified resumes for the following position.&nbsp; MAX pay rate is $Open&nbsp; /hr.&nbsp;for this position.&nbsp; Be sure to include&nbsp;rate and availability information.<br>
            <br>
            Regards,<br>
            <br>
            Arun&nbsp;<br>
            ...
            <table cellpadding="3" cellspacing="0" border="1" style="border-bottom-color: #51ae70; border-top-color: #51ae70; border-collapse: collapse; font: 12px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70">
                <tbody>
                    ...
                    <tr>
                        <td style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: 12px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70"><a href="#54448" class="font12Link"><span id="jobTitle">Sharepoint Developer</span> [ <span id="jobCode">VLINK_953</span> ] </a></td>
                        ...
                        <td style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: 12px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70"><span id="location">Chicago, IL</span></td>
                    </tr>
                </tbody>
            </table>
            <div>&nbsp;</div>
            ...
            <table width="100%" cellpadding="3" cellspacing="0" border="1" style="border-bottom-color: #51ae70; border-top-color: #51ae70; border-collapse: collapse; border-right-color: #51ae70; border-left-color: #51ae70">
                <tbody>
                    <tr bgcolor="#e0f8e0">
                        ...
                        <td align="left" width="95%" valign="top" style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: bold 12px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70"><span id="jobCode">VLINK_953</span> &nbsp; -&nbsp; <span id="jobTitle">Sharepoint Developer</span> ,&nbsp; <span id="location">Chicago, IL</span> .&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <p style="margin: 0in 0in 0pt"><font face="Times New Roman" size="3">Candidate with&nbsp;atleast 5 years of&nbsp;Sharepoint 2007 and preferably 2010 experience. Should be equally good from an Admin and Developer perspective.&nbsp; Candidate should have decent exposure&nbsp;&nbsp;to&nbsp; Microsoft Reporting Services 2005, Infopath 2007, Project Server 2007, and Project Server 2010, Ajax, and Webservices with sharepoint.<br>
                        &nbsp;<br>
                        &nbsp;</font></p>
                        ...
                        <p style="margin: 0in 0in 0pt"><font face="Times New Roman" size="3">SharePoint</font></p>
                        <p style="margin: 0in 0in 0pt"><font face="Times New Roman" size="3">&nbsp;</font></p>
                        <p style="margin: 0in 0in 0pt"><strong><font face="Times New Roman" size="3">Other Required Qualifications:</font></strong></p>
                        <p style="margin: 0in 0in 0pt"><font face="Times New Roman" size="3">Project Server 2007, and Project Server 2010, Ajax, and Webservices</font></p>
                        <p style="margin: 0in 0in 0pt"><font face="Times New Roman" size="3">&nbsp;</font></p>
                        </span></td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" width="95%" valign="top" style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: 11px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70"><span style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: bold 11px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70">Rate</span>&nbsp;:&nbsp;&nbsp;Open ,&nbsp; <span style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: bold 11px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70">Number of Openings</span>&nbsp;:&nbsp;&nbsp;6 ,&nbsp; <span style="border-bottom-color: #51ae70; border-top-color: #51ae70; font: bold 11px verdana; color: black; border-right-color: #51ae70; border-left-color: #51ae70">Duration</span>&nbsp;:&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" width="95%" valign="top"><a href="mailto:arun%40vlinkinfo.com?Subject=Applying%20for%20the%20job%20Sharepoint%20Developer[VLINK_953]" class="font11Link">Respond to this requirement.</a></td>
                    </tr>
                </tbody>
            </table>
            </div>
