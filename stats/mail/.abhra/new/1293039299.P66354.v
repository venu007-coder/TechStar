...
Received: from mx88.stngva01.us.mxservers.net (198.173.112.5)
	by mail19a.g19.rapidsite.net (RS ver 1.0.95vs) with SMTP id 3-0692679298
	for <abhra@altechstar.com>; Wed, 22 Dec 2010 12:34:58 -0500 (EST)
Received: from unknown [76.74.252.24] (EHLO rs78.luxhv.com)
	by va1-mx88.stngva01.us.mxservers.net (mxl_mta-3.1.0-05)
	with ESMTP id 2c6321d4.2826959776.168972.00-004.va1-mx88.stngva01.us.mxservers.net (envelope-from <andy@vlinkinfo.com>);
	Wed, 22 Dec 2010 12:34:58 -0500 (EST)
Received: from ip-10-196-81-219.ec2.internal (ec2-184-72-246-77.compute-1.amazonaws.com [184.72.246.77])
	(authenticated bits=0)
	by rs78.luxhv.com (8.13.8/8.13.8) with ESMTP id oBMHYq94014448;
	Wed, 22 Dec 2010 11:34:52 -0600
Date: Wed, 22 Dec 2010 12:34:51 -0500 (GMT-05:00)
From: Andy Duggal <andy@vlinkinfo.com>
To: andy@vlinkinfo.com
Message-ID: <1293039291942.049979346115695544.andy@vlinkinfo.com>
Subject: Datawarehousing Architect - 12months plus contract in Hartford, CT
MIME-Version: 1.0
Content-Type: multipart/mixed; 
	boundary="=_reb-r7CA8565A-t4D1236C2"
Importance: Normal
X-Lux-Comment: Message oBMHYq94014448 sent by user #76870; report Spam, UCE, or Abuse to abuse@luxsci.us
X-Lux-Comment: LuxSci High Volume Email: http://luxhv.com
X-Processed-By: Rebuild v2.0-0
X-Spam: [F=0.2000000000; B=0.500(0); S=0.200(2010121501); MH=0.500(2010122222)]
...
<table align="center" width="100%" cellpadding="10" cellspacing="0" border="1" style="border-bottom-color: #006aaf; border-top-color: #006aaf; border-collapse: collapse; border-right-color: #006aaf; border-left-color: #006aaf">
    <tbody>
        <tr>
            <td width="100%">
            <div id="customerLogo"><img src="cid:hN77D09ATM" alt="" border="0"><br>
            Rate: $70/hr Corp to Corp&nbsp;<br>
            <br>
            <div style="margin: 0in 0in 0pt"><font face="Calibri">Looking for a Datawarehouse architect for my client in Hartford, CT. Should be expert in Data modeling and well versed with OLAP, OLTP, ETL. The work in on architecting data models. DB2 is the database and knowledge of ab &ndash;initio is very helpful</font></div>
            <br>
            <br>
            <div id="messagebody" style="font: 12px verdana">&nbsp;</div>
            <a name="_MailAutoSig" class="FCK__AnchorC"><span style="font-family: 'Times New Roman','serif'; font-size: 12pt">Best regards,</span></a></div>
...
<table align="center" width="100%">
    <tbody>
        <tr>
            ...
            <td width="45%" align="left"><img src="cid:h2ECPBqMmk" alt="" height="20" width="20" align="bottom" border="0"></td>
        </tr>
    </tbody>
</table>
</div>
