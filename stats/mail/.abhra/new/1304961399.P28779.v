...
Received: from mx11.stngva01.us.mxservers.net (204.202.242.100)
	by mail19i.g19.rapidsite.net (RS ver 1.0.95vs) with SMTP id 3-0875371398
	for <abhra@altechstar.com>; Mon,  9 May 2011 13:16:38 -0400 (EDT)
Received: from unknown [182.72.145.156] (EHLO mail.systelcomputers.com)
	by va1-mx11.stngva01.us.mxservers.net (mxl_mta-3.1.0-05)
	with ESMTP id 37128cd4.1495264160.1042931.00-008.va1-mx11.stngva01.us.mxservers.net (envelope-from <ravikanthp@systelcomputers.com>);
	Mon, 09 May 2011 13:16:35 -0400 (EDT)
Received: from devine29.devine.com (unknown [192.168.0.143])
	by mail.systelcomputers.com (Postfix) with ESMTP id DB59F362B4
	for <abhra@altechstar.com>; Mon,  9 May 2011 13:16:28 -0400 (EDT)
From: "James - Systel Inc" <ravikanthp@systelcomputers.com>
To: "Partner" <abhra@altechstar.com>
Date: Mon, 09 May 2011 22:46:03 +0550
Subject: Hyperion, Websphere admin and Weblogic admin consultants available for contract positions
X-Mailer: Microsoft Office Outlook 11
Reply-To: ravikanthp@systelcomputers.com
X-CBOMsgID: 9DD5AEF107FDBA98352AFFB7AA33582B158588A2CD1C4276258CAD01C8235B
X-CBOEMailedTo: abhra@altechstar.com
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="=_reb-r6865BC07-t4DC82176"
Message-Id: <20110509171628.DB59F362B4@mail.systelcomputers.com>
...
--=_reb-r6865BC07-t4DC82176
Content-Type: multipart/alternative;
 boundary="=_reb-r091775BD-t4DC82176"

This is a multi-part MIME message.

--=_reb-r091775BD-t4DC82176
...
P K Hyperion Financial Reporting Studio, Hyperion Reports, Web Analysis, Hy=
perion Analyzer, Hyperion Spreadsheet Add-in, Hyperion System 9 Smart View =
7 Yrs
...
Name: P K - Hyperion Planning developer
Primary Skills: Hyperion Financial Reporting Studio, Hyperion Reports, Web =
Analysis, Hyperion Analyzer, Hyperion Spreadsheet Add-in, Hyperion System 9=
 Smart View
Summary: =95 7 years of Hyperion experience in design, analysis, developmen=
t and implementation of various applications in client/server environment u=
sing Hyperion Essbase, Hyperion Planning, Financial Reporting, Hyperion Int=
eractive Reporting, Web=20
Analysis, Shared Services, Smart View, Essbase Query Designer on Windows an=
d UNIX environments.
=95 Extensive experience working with multiple Hyperion products such as Hy=
perion System 11/9 Essbase, (Reports, Analyzer, Smart View, Analytic Servic=
es), Hyperion Planning 11.1.1.3/9.3.1, Hyperion Financial Management (HFM),=
 Hyperion Analyzer,=20
Hyperion reports (IR, FR).
=95 In-depth experience in Hyperion components such as Essbase Excel Add-In=
, Essbase Query Designer, ESSCMD and MaxL Automation. For Essbase Maintaine=
d database optimization while performing Dynamic Dimension Building, Data L=
oading, Calculation=20
Scripts, Report Scripts, and Cache Management.
=95 Expertise in Essbase cube analysis, design and maintenance, Essbase dat=
abase administration upgrades, performance tuning and optimization on Windo=
ws and UNIX environments.
=95 Proficient in Hyperion Essbase Application Manager modules; Outline Edi=
tor, Report Editor, Calc Script Editor, and Data Prep Editor.=20
=95 Expertise in writing custom Essbase calculation scripts, automating the=
 Essbase cubes using MaxL, ESSCMD and batch scheduling the MaxL scripts.
=95 Extensive experience in application designing and development using Ora=
cle EPM system 11.1, Hyperion Essbase 11.1.2/11.1.1.3/9.x/7.x/6.x,Hyperion =
Financial Reports, ESSCMD, MAXL, Essbase Excel Add-In and Hyperion web Anal=
yzer.
=95 Hands on experience in installation, configuration and maintenance of H=
yperion Shared services 9.x/11.x, Hyperion Essbase 9.x/11.x, Administration=
 Services 9.x/11.x.
=95 Created the Meta Data using EPMA (Data synchronization, ADS files)
=95 Experience in creation and maintenance of finance, ledger, planning and=
 reporting cubes across Block storage (BSO) and Aggregate Storage (ASO) Ess=
base kernels.
=95 Extensive experience in creating reports using Financial Reports, Essba=
se Excel Add-In, Hyperion Analyzer, Smart view, EIS, MDM or DRM, ODI, EPMA.
=95 Experience in architecting complete data models combining multiple tran=
saction systems ETL tools INFORMATICA Power Center 7.0 and relational and m=
ultidimensional data stores for star schema, snowflakes schema designs and =
reporting tools.
=95 Work experience Integration tools Like Hyperion Application Link (HAL),=
 Hyperion Data Integration Management (DIM), Hyperion Financial Data Qualit=
y Management (FDQM), Hyperion Essbase Integration services (EIS), Oracle Da=
ta Integrator (ODI).
=95 Experience in developing complex reports in Hyperion Interactive Report=
ing Studio V 9.3.1 (BRIO) & Hyperion Web Analyzer 6.5/7.0.=20
=95 Experience in Hyperion Financial Management (HFM) from the scratch star=
ting from meeting with Business user together requirements until deployment=
 on the production server.=20
=95 Good understanding of coding in PL/SQL and very strong in performance t=
uning and database design expert level Oracle 11g/10g/9i/8i /7.x.
=95 Ability to meet deadlines and handle pressure in coordinating multiple =
tasks in a work/project environment. Versatile team player with excellent a=
nalytical, presentation and inter-personal skills.
=95 Strong communication, organizational and interpersonal competencies alo=
ng with detail oriented and problem solving skills in the technology arena.
...
Content-Type: multipart/related;
 boundary="=_reb-r0B51E5F5-t4DC82176"

This is a multi-part MIME message.

--=_reb-r0B51E5F5-t4DC82176
...
available.</DIV>
      ...
      <TABLE border="1" borderColorLight="#9480bc" cellPadding="3" borderColorDark="#ffffff" cellSpacing="0" borderColor="#ffffff" class="font12">
        ...
        <TR id="CS00000018">
          <TD><A href="#CS00000018"><SPAN id="ConsultantID">P K</SPAN></A></TD>
          <TD><SPAN id="PrimarySkills">Hyperion Financial Reporting Studio, 
            Hyperion Reports, Web Analysis, Hyperion Analyzer, Hyperion 
            Spreadsheet Add-in, Hyperion System 9 Smart View</SPAN></TD>
          <TD><SPAN id="TotalExp">7 Yrs</SPAN></TD></TR>
        <TR id="CS00000003">
...
<TABLE border="1" borderColorLight="#9480bc" cellPadding="0" borderColorDark="#ffffff" cellSpacing="0" borderColor="#ffffff" class="font11">
  ...
  <TR>
    <TD align="left">
      <DIV id="CS00000018"><A name="CS00000018"></A>
      <TABLE border="1" borderColorLight="#9480bc" width="100%" cellPadding="3" borderColorDark="#ffffff" cellSpacing="0" borderColor="#ffffff" class="font11">
        <TBODY>
        <TR>
          <TD bgColor="#ded6ed" width="120" align="right" class="font12bold">Name:</TD>
          <TD bgColor="#ded6ed" class="font12bold"><SPAN id="ConsultantID">P 
            K</SPAN> - <SPAN id="JobTitle">Hyperion Planning 
developer</SPAN></TD></TR>
        <TR>
          <TD width="120" align="right" class="font11bold">Primary Skills:</TD>
          <TD><SPAN id="PrimarySkills">Hyperion Financial Reporting Studio, 
            Hyperion Reports, Web Analysis, Hyperion Analyzer, Hyperion 
            Spreadsheet Add-in, Hyperion System 9 Smart View</SPAN></TD></TR>
        <TR>
          <TD width="120" align="right" class="font11bold">Summary:</TD>
          <TD><SPAN id="Summary">&#8226; 7 years of Hyperion experience in design, 
            analysis, development and implementation of various applications in 
            client/server environment using Hyperion Essbase, Hyperion Planning, 
            Financial Reporting, Hyperion Interactive Reporting, Web Analysis, 
            Shared Services, Smart View, Essbase Query Designer on Windows and 
            UNIX environments.<br>
&#8226; Extensive experience working with multiple 
            Hyperion products such as Hyperion System 11/9 Essbase, (Reports, 
            Analyzer, Smart View, Analytic Services), Hyperion Planning 
            11.1.1.3/9.3.1, Hyperion Financial Management (HFM), Hyperion 
            Analyzer, Hyperion reports (IR, FR).<br>
&#8226; In-depth experience in 
            Hyperion components such as Essbase Excel Add-In, Essbase Query 
            Designer, ESSCMD and MaxL Automation. For Essbase Maintained 
            database optimization while performing Dynamic Dimension Building, 
            Data Loading, Calculation Scripts, Report Scripts, and Cache 
            Management.<br>
&#8226; Expertise in Essbase cube analysis, design and 
            maintenance, Essbase database administration upgrades, performance 
            tuning and optimization on Windows and UNIX environments.<br>
&#8226; 
            Proficient in Hyperion Essbase Application Manager modules; Outline 
            Editor, Report Editor, Calc Script Editor, and Data Prep Editor. 
            <br>
&#8226; Expertise in writing custom Essbase calculation scripts, 
            automating the Essbase cubes using MaxL, ESSCMD and batch scheduling 
            the MaxL scripts.<br>
&#8226; Extensive experience in application designing 
            and development using Oracle EPM system 11.1, Hyperion Essbase 
            11.1.2/11.1.1.3/9.x/7.x/6.x,Hyperion Financial Reports, ESSCMD, 
            MAXL, Essbase Excel Add-In and Hyperion web Analyzer.<br>
&#8226; Hands on 
            experience in installation, configuration and maintenance of 
            Hyperion Shared services 9.x/11.x, Hyperion Essbase 9.x/11.x, 
            Administration Services 9.x/11.x.<br>
&#8226; Created the Meta Data using 
            EPMA (Data synchronization, ADS files)<br>
&#8226; Experience in creation 
            and maintenance of finance, ledger, planning and reporting cubes 
            across Block storage (BSO) and Aggregate Storage (ASO) Essbase 
            kernels.<br>
&#8226; Extensive experience in creating reports using 
            Financial Reports, Essbase Excel Add-In, Hyperion Analyzer, Smart 
            view, EIS, MDM or DRM, ODI, EPMA.<br>
&#8226; Experience in architecting 
            complete data models combining multiple transaction systems ETL 
            tools INFORMATICA Power Center 7.0 and relational and 
            multidimensional data stores for star schema, snowflakes schema 
            designs and reporting tools.<br>
&#8226; Work experience Integration tools 
            Like Hyperion Application Link (HAL), Hyperion Data Integration 
            Management (DIM), Hyperion Financial Data Quality Management (FDQM), 
            Hyperion Essbase Integration services (EIS), Oracle Data Integrator 
            (ODI).<br>
&#8226; Experience in developing complex reports in Hyperion 
            Interactive Reporting Studio V 9.3.1 (BRIO) &amp; Hyperion Web 
            Analyzer 6.5/7.0. <br>
&#8226; Experience in Hyperion Financial Management 
            (HFM) from the scratch starting from meeting with Business user 
            together requirements until deployment on the production server. 
            <br>
&#8226; Good understanding of coding in PL/SQL and very strong in 
            performance tuning and database design expert level Oracle 
            11g/10g/9i/8i /7.x.<br>
&#8226; Ability to meet deadlines and handle 
            pressure in coordinating multiple tasks in a work/project 
            environment. Versatile team player with excellent analytical, 
            presentation and inter-personal skills.<br>
&#8226; Strong communication, 
            organizational and interpersonal competencies along with detail 
            oriented and problem solving skills in the technology 
            arena.<br>
</SPAN></TD></TR>
        <TR>
          <TD width="120" align="left">&nbsp;</TD>
        ...
        <TR>
          <TD width="120" align="left"><A href="#Top">Goto Top</A></TD>
          <TD><A href="mailto:ravikanthp@systelcomputers.com?Subject=Resume_of_P%20K">Receive 
            Resume by 
    EMail</A>&nbsp;&nbsp;&nbsp;&nbsp;</TD></TR></TBODY></TABLE></DIV></TD></TR>
  <TR>
    <TD align="left">
