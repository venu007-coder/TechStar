...
Received: from mx76.stngva01.us.mxservers.net (204.202.242.147)
	by mail19g.g19.rapidsite.net (RS ver 1.0.95vs) with SMTP id 0-0742133905
	for <bpojobs@altechstar.com>; Fri,  5 Jun 2009 08:11:45 -0400 (EDT)
Received: from unknown [82.146.52.229] (EHLO it-professionalz.com)
	by va1-mx76.stngva01.us.mxservers.net (mxl_mta-3.1.0-05)
	with ESMTP id 18b092a4.2782276512.687970.00-003.va1-mx76.stngva01.us.mxservers.net (envelope-from <nikhiilsahayy@gmail.com>);
	Fri, 05 Jun 2009 08:11:45 -0400 (EDT)
Received: from GOV ([59.93.78.84])
	(authenticated bits=0)
	by it-professionalz.com (8.14.3/8.14.2) with ESMTP id n55CBYwD030999
	(version=TLSv1/SSLv3 cipher=RC4-MD5 bits=128 verify=NO)
	for <bpojobs@altechstar.com>; Fri, 5 Jun 2009 12:11:40 GMT
	(envelope-from nikhiilsahayy@gmail.com)
Reply-To: nikhiilsahay@gmail.com
Message-ID: <ce68393ff5bce83f7ef116d20013ac3b@gmail.com>
From: "Nikhil Sah" <nikhiilsahayy@gmail.com>
To: <bpojobs@altechstar.com>
Subject: =?windows-1252?Q?Websphere_Administrator/Websphere_Portal_Admin(7_yrs_insurance_industry_experience)_available_for_corp_to_corp_contracts_anywhere_in_US.?=
Date: Fri, 5 Jun 2009 08:10:31 -0400
MIME-Version: 1.0
Content-Type: text/plain;
	charset="windows-1252"
Content-Transfer-Encoding: quoted-printable
X-Spam: [F=0.2000000000; B=0.500(0); S=0.200(2009052001); MH=0.500(2009060517)]
X-MAIL-FROM: <nikhiilsahayy@gmail.com>
X-SOURCE-IP: [82.146.52.229]
X-SF-Loop: 1
...
I am in Kansas City, MO and am available with a week notice.  I can =
relocate anywhere in US and can go for a face to face interview if =
required=2E
I am on H1B visa=2E
...
Summary:
?	7 years of experience in System Administration and Application =
Deployment of Middleware and related products
?	Administrating and Implementing of web applications using WebSphere =
...
?	Experience in Implementing, configuring, administrating, deployment, =
upgrading and maintenance on multi platforms (SUN Solaris, AIX, Linux and =
Windows)=2E
?	Experience in configuring MQ and SIB resources with WebSphere =
Application Server=2E
?	Experience in configuring IBM WebSphere Portal Server with a variety of =
databases including Oracle and MS SQL Server=2E
?	Good experience in MQ Series, Documentum, TIBCO etc for mission critical =
JAVA/J2EE based enterprise applications=2E
?	Experience in handling Workload Management (WLM) of WebSphere =
Application Server using cloning and clustering concept, including cloning =
for failover and backup/recovery processes=2E
?	Good understanding in integrating and packaging enterprise-wide J2EE =
...
?	Configured WebSphere resources, Database connection using JDBC providers =
including tuning the connection pool to support high transaction =
applications.=20
?	Experience in configuring and administering IBM MQ Series and good =
knowledge of WMQI
?	Configuring connectivity using WebSphere MQ, MDB=92s and fine tuning =
high transaction Enterprise Application=92s performance using connection =
pooling resources.=20
?	Experience in tuning message listener ports for MDB=92s high transaction =
EJB application including JNDI setup for Queue connection factory and =
queue destinations.=20
?	Experience in installation, troubleshooting and configuration of =
Documentum based components like DFC=92s, Webtop=92s and DA=2E
?	Excellent experience in troubleshooting and Performance tuning using =
various network, thread and http related tools=2E
?	Excellent experience in working on securing web applications using =
netegrity Siteminder and Network topologies=2E
?	Experience in 24x7 production support, best practice trouble shooting, =
monitoring, capacity planning, performance tuning, naming standards, =
security and maintenance=2E
?	Good experience in installation, upgrading and configuration of Jboss, =
Sunone, iPlanet, Apache/tomcat software components and servers.=20
?	Experience in configuring and administering JMS providers like TIBCO=20
?	Excellent inter personal, technical, analytical and leadership skills
...
Education:
?	Bachelor in Computer Application, from IG University, India
?	Advance Diploma in Software Engineering from Aptech, New Delhi, India

Certifications & Trainings
?	IBM WebSphere Application Server 6.1 training
?	Cisco Certified network associate (CCNA)
?	Green Belt Six Sigma Certified=20
